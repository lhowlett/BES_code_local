...
def plot_velocities_same_channel(
        shot, apdpos, velocity_array_1, correlation_array_1, velocity_array_2, 
...
def plot_velocities_multiple_channels(
        shot, apdpos, channels, num_slices, velocities, correlations, time_points, 
...
def plot_vel_profile_with_dalpha(
        shot, apdpos, velocity_array, time_points, corr_array, row, num_slices, 
...
def plot_two_velocity_locations_with_dalpha(
        shot, apdpos, dalpha_time, dalpha_data, velocity_array, correlation_array, 
