...
def plot_cctde_analysis_poloidal(
        shot, apdpos, bes_time, fluct_data, mid_time_point, slices, time_base, 
        xcorr_length, timepoint_number, row, column, fname, chan_list, 
        fit_range):
...
def plot_cctde_analysis_radial(
        shot, apdpos, bes_time, fluct_data, mid_time_point, slices, time_base, 
        xcorr_length, timepoint_number, row, column, fname, radial_chans_list, 
        fit_range):
...
def plot_velocity_distribution(
        shot, apdpos, velocity_array, row, column, num_slices, length, fname, 
...
def plot_velocity_comparison_same_axis(
        shot, apdpos, velocity_array_1, velocity_array_2, corr_vals_1, corr_vals_2, 
...
def plot_fit_type_velocities(
        shot, apdpos, dalpha_time, dalpha_data, list_of_velocities, list_of_times, 
...
def plot_poloidal_radial_velocity_correlation(
        shot, apdpos, row, column, mid_time_points, pol_vels, pol_corr, rad_vels, 
